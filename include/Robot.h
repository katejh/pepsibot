...
class Robot
{
    ...
    private:
        static const int neutral_speed = 200;
        static const int torque_vs_pwm_offset = 150; // offset value to linearize torque vs pwm since function is not exactly linear due to friction
